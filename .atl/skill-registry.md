# Skill Registry — manejo-finanzas
...
- /home/yeshua/.config/opencode/skills
- /home/yeshua/.claude/skills
- /home/yeshua/.gemini/skills
- /home/yeshua/.copilot/skills
...
### ai-sdk-5
- Path: /home/yeshua/.claude/skills/ai-sdk-5/SKILL.md
- Trigger: >
- Rules:
...
### branch-pr
- Path: /home/yeshua/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/yeshua/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/yeshua/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/yeshua/.config/opencode/skills/comment-writer/SKILL.md
...
### django-drf
- Path: /home/yeshua/.claude/skills/django-drf/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /home/yeshua/.config/opencode/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/yeshua/.config/opencode/skills/issue-creation/SKILL.md
...
### jira-epic
- Path: /home/yeshua/.claude/skills/jira-epic/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### jira-task
- Path: /home/yeshua/.claude/skills/jira-task/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### judgment-day
- Path: /home/yeshua/.config/opencode/skills/judgment-day/SKILL.md
...
### nextjs-15
- Path: /home/yeshua/.claude/skills/nextjs-15/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### playwright
- Path: /home/yeshua/.claude/skills/playwright/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### pytest
- Path: /home/yeshua/.claude/skills/pytest/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### react-19
- Path: /home/yeshua/.claude/skills/react-19/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/yeshua/.config/opencode/skills/skill-creator/SKILL.md
...
### tailwind-4
- Path: /home/yeshua/.claude/skills/tailwind-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript
- Path: /home/yeshua/.claude/skills/typescript/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/yeshua/.config/opencode/skills/work-unit-commits/SKILL.md
...
### zod-4
- Path: /home/yeshua/.claude/skills/zod-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### zustand-5
- Path: /home/yeshua/.claude/skills/zustand-5/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
